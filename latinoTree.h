...
// Mon Mar 30 13:45:11 2015 by ROOT version 5.34/23
// from TTree latino/probe_tree
// found on file: latino/latino_stepB_QCD_Pt-20toInf.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("latino/latino_stepB_QCD_Pt-20toInf.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("latino/latino_stepB_QCD_Pt-20toInf.root");
      }
