...
// Thu Apr 23 14:59:26 2015 by ROOT version 5.34/23
// from TTree latino/probe_tree
// found on file: /gpfs/csic_projects/cms/trevisanin/newLatino/stepB_TTJets_gen_v0.root
//////////////////////////////////////////////////////////
...
#ifdef latinoTree_cxx
latinoTree::latinoTree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/gpfs/csic_projects/cms/trevisanin/newLatino/stepB_TTJets_gen_v0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/gpfs/csic_projects/cms/trevisanin/newLatino/stepB_TTJets_gen_v0.root");
      }
...
latinoTree::~latinoTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t latinoTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t latinoTree::LoadTree(Long64_t entry)
{
...
void latinoTree::Init(TTree *tree)
{
...
void latinoTree::Show(Long64_t entry)
{
...
Int_t latinoTree::Cut(Long64_t entry)
{
