...
const UInt_t nProcesses = 17 ;

//enum {iData, iWW, iWZ, iZZ, iWg, itt, itW, iWj, iDY, iDYtau, iH125};
enum {iData, iWW, iqqWW, itt, itW, iWZ, iZZ, iWg, iWgS, iWj, iDY, iDYtau, iVBF,  iZg, iVVV, iH125, ittFakes};
...
process[itt]    = "TTbar";
process[itW]    = "TW";
process[iWW]    = "ggWWto2L";//_smear";
process[iqqWW]  = "WWTo2L2Nu_pow_nnll";//_smear";
process[iWZ]    = "WZ";
process[iZZ]    = "ZZ";
process[iWg]    = "WgammaNoStar";
process[iWgS]   = "WgammaStar";
process[iWj]    = "WJetsMC"//"WJetsFakes_Total";
process[iDY]    = "DY";
